    ...
    info: [
      {
        ...
        stage: `From 27 Mar 2017 to ${CurYear}`,
      },
      {
        title: "Microsoft Certified: DevOps Engineer Expert",
        stage: `From 22 Nov 2024 To 23 Nov ${NextYear}`,
      },
      {
      ...
      },
      {
        ...
        stage: `From 24 Mar 2017 To ${CurYear}`,
      },
      {
        title:
      ...
      },
      {
        ...
        stage: `From 16 Gen 2017 To ${CurYear}`,
      },
      {
        title: "Microsoft Certified Professional",
        stage: `From 21 Ott 2014 To ${CurYear}`,
      },
      {
        title:
          "Microsoft® Certified Technology Specialist: SharePoint 2010, Application Development",
        stage: `From 12 Sett 2013 To ${CurYear}`,
      },
    ],
  },
  {
...
const Company = () => {
  ...
  return (
    <LayoutEnUs>
      <Head>
        <title>Vivasoft - Presentation</title>
        <meta
          name="description"
          content="Find out who we are and what we do. Vivasoft offers innovative Microsoft solutions in the IT industry."
        />
        <meta
          name="keywords"
          content="Vivasoft, IT solutions, Microsoft Sharepoint online, Microsoft Sharepoint on-premises, Microsoft Power Apps, Power BI, Power Automate, C#, Python, React and Angular consulting, Microsoft certifications , AZ-305, AZ-204, AZ-104, AZ-400, AZ-220, AZ-900, AI-900, AI-102, DP-100, PL-200, PL-300,PL-400,PL-500, PL-600, PL-900, MS-900, CKA, CKAD"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Vivasoft - Presentation" />
        <meta
          property="og:description"
          content="See how Vivasoft helps companies innovate and optimize business processes."
        />
      ...
      <div className="h-full bg-primary xl:py-60 py-80 text-center xl:text-left bg-gradient-to-r from-primary via-black/30 to-black/10">
        <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
          ...
          <div className="flex-1 flex flex-col justify-center xl:pt-0 pt-20">
            ...
            >
              <span className='text-lg font-bold'>For more than 10 years it is a consolidated reality in the IT sector, </span>
              <span className='text-lg'>specialized in teaching and in the realization of solutions based on the platforms{" "}</span>
              <span className="text-lg text-secondary">
                Microsoft Sharepoint, Microsoft Power Apps, Power BI and Power Automate.
              </span>
            </motion.p>
                    {/* particles */}
          <ParticlesContainer />
